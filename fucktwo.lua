...
if (not Drawing) then
    return LocalPlayer:Kick("drawing library not supported");
end;
...
function CheckPlayer(Player)
	...
	if Player ~= LocalPlayer and Player.Character then
		...
		if Pass and Player.Character and Head then
			...
			if Distance > (shared.cMaxDrawDistance or Options.MaxDistance.Value) then
				Pass = false;
			end
		end
	else
...
shared.toggleESPOption = function(...)
    Options(...);    
end
